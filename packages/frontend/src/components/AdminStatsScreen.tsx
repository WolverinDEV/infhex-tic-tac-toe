    ...
    return (
        ...
        >
            <div className="flex items-end justify-between gap-3">
                ...
                <div className="text-2xl font-black leading-none text-white sm:text-[1.8rem]">
                    {value}
                </div>
            </div>
        </div>
            ...
            {game && value ? (
                <>
                    ...
                    <div className="mt-2 line-clamp-2 text-sm leading-5 text-slate-300">
                        {game.players.join(` vs `) || game.sessionId}
                    </div>

                    <div className="mt-1 text-[0.68rem] uppercase tracking-[0.16em] text-slate-500">
                        {game.sessionId}
                    </div>
...
function UserWindowCard({
    ...
    return (
        <section className="rounded-3xl border border-white/10 bg-white/6 p-4 shadow-[0_20px_60px_rgba(15,23,42,0.28)]">
            <div className="text-[0.68rem] uppercase tracking-[0.3em] text-emerald-200/80">
                {title}
            </div>

    ...
    return (
        <div className="rounded-[1.35rem] border border-amber-300/25 bg-amber-300/10 px-5 py-5">
            ...
            <div className="mt-1 text-xs uppercase tracking-[0.18em] text-amber-100/75">
                {`Scheduled `}
                {formatDateTime(intlFormatProvider, shutdown.scheduledAt)}
            </div>
        </div>
    );
}
                                    ...
                                    {activeGames.map((session) => (
                                        ...
                                        >
                                            <div className="min-w-0">
                                                ...
                                                <div className="mt-3 break-all text-lg font-bold text-white sm:text-xl">
                                                    {session.id}
                                                </div>

                                                <div className="mt-1 text-sm text-slate-300">
                                                    {formatLobbyPlayers(session.players, session.rated, `Waiting for players`)}
                                                </div>
